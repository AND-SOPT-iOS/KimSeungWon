...
class LoginView: UIView {
    ...
    lazy var usernameTextField = BasicTextField("아이디를 입력해 주세요")
    ...
    private func setupUI() {
        ...
        self.addSubviews(iOSImageView, titleLabel, subTitleLabel, usernameTextField, passwordTextField, loginButton, createAccountLabel)
    }
